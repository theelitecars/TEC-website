...
// _ echo str_replace(" ", "-", strtolower($category['singular']));  
//echo get_post_meta($post->ID, 'stock-no', true);

		        				$text_value = get_post_meta($post->ID, str_replace(" ", "-", strtolower($category['singular'])), true);
		        				//echo $text_value;
